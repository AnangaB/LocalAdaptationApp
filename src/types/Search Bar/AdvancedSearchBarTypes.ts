...
//assigns a search type to each header in the advanced search bar menu
  ...
  export const searchCheckBoxOptions: CheckBoxItems= {
    "Eco-Evo Focus": [
      ...
      "Speciation",
      "Ecological Genomics",
      "Pop. Persistence and Conservation",
    ],
    "Life history": ["Discrete", "Continuous","Both", "Unknown"],
    ...
    Ploidy: ["Haploid", "Diploid", "Haplodiploid", "Other", "Unknown"],
    Selection: [
      "Gaussian/Quad Stab",
      "GFG",
      "MAM",
    ...
    "Spatial Structure": [
      ...
      "Island Mainland",
      "Stepping Stone (1D or 2D)",
      "Continuous Space (1D or 2D)",
      "Other",
      "Unknown",
    ],

    "Population Size": ["Finite", "Infinite", "Both", "Other","Unknown"],
    "Ecological Model": [
      "Constant",
      "Stochastic",
      "Intraspecific Competition",
      'Host-Parasite/Pred-pray',
